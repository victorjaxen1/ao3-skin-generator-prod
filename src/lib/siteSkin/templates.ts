...
export const TEMPLATES: readonly SiteSkinTheme[] = [
  {
    ...
    shape: { cardRadius: '10px', tagStyle: 'pill' },
    header: NO_BANNER,
    details: { divider: true, dropCap: true },
  },
  {
    schemaVersion: 1,
    ...
    shape: { cardRadius: '4px', tagStyle: 'label' },
    header: NO_BANNER,
    details: { divider: false, dropCap: true },
  },
  {
    schemaVersion: 1,
    ...
    shape: { cardRadius: '18px', tagStyle: 'pill' },
    header: NO_BANNER,
    details: { divider: false, dropCap: false },
  },
  {
    schemaVersion: 1,
    ...
    shape: { cardRadius: '10px', tagStyle: 'label' },
    header: NO_BANNER,
    details: { divider: true, dropCap: true },
  },
  {
  ...
  },
  {
    ...
    shape: { cardRadius: '0px', tagStyle: 'plain' },
    header: NO_BANNER,
    details: { divider: false, dropCap: false },
  },
  {
